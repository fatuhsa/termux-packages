...
termux_step_post_make_install() {
	{
		echo "# The Sanix repository (io.sanix)"
		echo "deb [signed-by=$TERMUX_PREFIX/etc/apt/trusted.gpg.d/sanix-repo.gpg] https://fatuhsa.github.io/termux-packages/ stable main"
